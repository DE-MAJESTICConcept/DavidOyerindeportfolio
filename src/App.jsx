...
// /** * ASSET MOCKUP 
//  * Note: In your local environment, replace these strings with your actual imports:
//  * import daMusik from './assets/da-musik.png'; etc.
//  */
// const logo = "https://via.placeholder.com/60";
// const profilePhoto = "https://via.placeholder.com/300";

// // --- PORTFOLIO DATA ---
// export const portfolioData = {
//   title: "Creative Graphic, UI/UX & Frontend Developer",
//   name: "Oyerinde David",
//   summary: "A versatile creative bridging the gap between aesthetic design and functional development. Specialist in Brand Identity, Motion Graphics, and Responsive Web Applications.",
...
//   skills: {
//     graphicDesign: [
//       "Adobe Photoshop — Expert photo editing",
//       "Adobe Illustrator — Logo & Vector design",
//       "CorelDRAW — Print & Branding layouts",
//       "Color Theory & Typography Mastery",
//     ],
//     motionGraphics: [
//       "Adobe After Effects — Pro animation",
//       "Premiere Pro — Video editing",
//       "Canva & Figma — Rapid layouts",
//     ],
//     frontendDev: [
//       "React.js — Component-based UI",
//       "JavaScript (ES6+) — Functional logic",
//       "Tailwind & Bootstrap — Responsive CSS",
//       "Vite & Git — Modern workflow",
//     ],
//     other: [
//       "Team Collaboration",
//       "Creative Direction",
...
//   projects: {
//     brandIdentity: [
//       { id: 'bi1', name: 'Music Album: "Celebrate"', category: 'Album Art', description: 'Vibrant album cover design.', src: "https://via.placeholder.com/600x400" },
//       { id: 'bi2', name: 'De-Majestic Branding', category: 'Branding', description: 'Creative identity graphics.', src: "https://via.placeholder.com/600x400" },
//     ],
//     animations: [
//       { id: 'an4', title: 'Event Teaser', thumbnail: "https://via.placeholder.com/600x400", videoUrl: "#", description: 'Dynamic video teaser.' },
//       { id: 'an5', title: 'Christmas Celebration', thumbnail: "https://via.placeholder.com/600x400", videoUrl: "#", description: 'Festive animation.' },
//     ],
//     socialMedia: [
//       { id: 'sm1', name: 'Data Science Campaign', category: 'Social Media', description: 'Engaging campaign visuals.', src: "https://via.placeholder.com/600x400" },
//     ],
...
//         description: 'Personal portfolio with dynamic routing and interactive galleries.',
//         liveLink: '#',
//         repoLink: '#',
...
//         description: 'A clean shop interface with cart functionality.',
//         liveLink: '#',
//         repoLink: '#',
//         src: "https://via.placeholder.com/600x400"
//       }
...
//         description: 'User flow and high-fidelity mockups for a banking app.',
//         figmaLink: '#',
//         src: "https://via.placeholder.com/600x400"
//       }
//     ]
...
//           <>
//             {/* Hero Section */}
//             <section className="d-flex align-items-center justify-content-center min-vh-100 bg-black text-white py-5">
//               <div className="container text-center py-5">
//                 <h1 className="display-3 fw-bolder bg-dark-custom p-4 rounded-xl shadow-lg-custom">
//                   Welcome, I'm <span className="text-gold">{portfolioData.name}</span>
//                 </h1>
//                 <p className="fs-2 fw-light mt-4">A <span className="text-white">{portfolioData.title}</span></p>
//                 <a href="#projects" className="btn btn-gold btn-lg rounded-pill mt-5 px-5 py-3 shadow-lg-custom">View My Work</a>
//               </div>
//             </section>

//             {/* About Section */}
//             <section id="about" className="py-5 bg-dark-custom border-top border-dark-subtle">
//               <div className="container py-5">
//                 <h2 className="display-4 fw-bold text-center text-gold mb-5 border-bottom border-gold pb-3">About My Craft</h2>
//                 <div className="row g-5 align-items-center">
//                   <div className="col-md-5">
//                     <img src={profilePhoto} alt="Profile" className="img-fluid rounded-circle shadow-lg-custom border border-dark-subtle d-block mx-auto" style={{ width: '300px', height: '300px', objectFit: 'cover' }} />
//                   </div>
//                   <div className="col-md-7">
//                     <p className="fs-5 text-secondary">{portfolioData.summary}</p>
//                     <h3 className="text-white mt-4">Education & Training</h3>
//                     <ul className="list-unstyled space-y-3">
//                       {portfolioData.education.map((edu, i) => (
//                         <li key={i} className="text-secondary"><span className="text-gold me-2">•</span><strong>{edu.degree}</strong> {edu.notes}</li>
//                       ))}
//                     </ul>
//                   </div>
//                 </div>
...
//               <div className="container py-5">
//                 <h2 className="display-4 fw-bold text-center text-gold mb-5 border-bottom border-gold pb-3">My Expertise</h2>
//                 <div className="row g-4">
//                   <SkillCard title="Graphic Design" skills={portfolioData.skills.graphicDesign} />
//                   <SkillCard title="Motion Graphics" skills={portfolioData.skills.motionGraphics} />
//                   <SkillCard title="Frontend Dev" skills={portfolioData.skills.frontendDev} />
//                 </div>
//               </div>
//             </section>

//             {/* Main Navigation to Galleries */}
//             <section id="projects" className="py-5 bg-dark-custom border-top border-dark-subtle">
//               <div className="container py-5">
//                 <h2 className="display-4 fw-bold text-center text-gold mb-5 border-bottom border-gold pb-3">Portfolio Categories</h2>
//                 <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 justify-content-center">
//                   <CategoryCard title="Frontend Projects" icon="💻" onClick={() => setCurrentPage('frontend')} />
//                   <CategoryCard title="UI/UX Designs" icon="✨" onClick={() => setCurrentPage('uiux')} />
//                   <CategoryCard title="Brand Identity" icon="🎨" onClick={() => setCurrentPage('brandIdentity')} />
//                   <CategoryCard title="Animations" icon="🎬" onClick={() => setCurrentPage('animations')} />
//                   <CategoryCard title="Social Media" icon="📱" onClick={() => setCurrentPage('socialMedia')} />
//                 </div>
//               </div>
//             </section>

//             {/* Contact Section */}
//             <section id="contact" className="py-5 bg-black border-top border-dark-subtle">
//               <div className="container text-center py-5">
//                 <h2 className="display-4 text-gold mb-5">Connect With Me</h2>
//                 <div className="d-flex flex-column align-items-center gap-3">
//                   <p className="fs-4 text-white">📞 {portfolioData.Contact.phone}</p>
//                   <p className="fs-4 text-white">✉️ <a href={`mailto:${portfolioData.Contact.Email}`} className="text-gold text-decoration-none">{portfolioData.Contact.Email}</a></p>
//                 </div>
//               </div>
//             </section>
//           </>
//         );
//       case 'frontend':
//         return <FrontendGallery projects={portfolioData.projects.frontend} onBack={() => setCurrentPage('home')} />;
//       case 'uiux':
//         return <UIUXGallery projects={portfolioData.projects.uiux} onBack={() => setCurrentPage('home')} />;
//       case 'brandIdentity':
//         return <StandardGallery title="Brand Identity" projects={portfolioData.projects.brandIdentity} onBack={() => setCurrentPage('home')} />;
//       case 'animations':
//         return <AnimationGallery projects={portfolioData.projects.animations} onBack={() => setCurrentPage('home')} onPlayVideo={setSelectedVideo} />;
//       case 'socialMedia':
//         return <StandardGallery title="Social Media Graphics" projects={portfolioData.projects.socialMedia} onBack={() => setCurrentPage('home')} />;
//       default:
//         return null;
//     }
//   };
...
//         .border-dark-subtle { border-color: #333 !important; }
...
//         .shadow-lg-custom { box-shadow: 0 1rem 3rem rgba(0,0,0,0.8); }
//         .card-custom { transition: 0.3s; border: 1px solid #333; }
//         .card-custom:hover { transform: translateY(-5px); border-color: #FFD700; }
//         .cursor-pointer { cursor: pointer; }
//       `}</style>

//       {/* Navbar */}
//       <nav className="navbar navbar-expand-lg bg-dark sticky-top border-bottom border-dark-subtle">
//         <div className="container">
//           <a className="navbar-brand text-gold fw-bold d-flex align-items-center" href="#" onClick={() => setCurrentPage('home')}>
//             <img src={logo} className="rounded-circle me-2" style={{width: '40px'}} alt="Logo" /> David
//           </a>
//           <div className="ms-auto d-flex gap-3">
//             <button onClick={() => setCurrentPage('home')} className="btn btn-sm btn-outline-gold text-white">Home</button>
//             <a href="#contact" className="btn btn-sm btn-gold">Hire Me</a>
//           </div>
//         </div>
//       </nav>
...
//                 <h5 className="text-gold">{selectedVideo.title}</h5>
//                 <button className="btn-close btn-close-white" onClick={() => setSelectedVideo(null)}></button>
//               </div>
//               <div className="modal-body">
//                 <div className="ratio ratio-16x9">
//                   <video controls autoPlay src={selectedVideo.videoUrl} />
//                 </div>
//               </div>
//             </div>
//           </div>
...
//       <footer className="py-5 text-center bg-black border-top border-dark-subtle text-secondary">
//         <p>© {new Date().getFullYear()} Oyerinde David. All rights reserved.</p>
//       </footer>
//     </div>
//   );
// }
...
//     <div className="card h-100 bg-darker-custom rounded-xl p-4 card-custom">
//       <h3 className="text-gold mb-4">{title}</h3>
//       <ul className="list-unstyled text-secondary">
//         {skills.map((s, i) => <li key={i} className="mb-2">✓ {s}</li>)}
//       </ul>
//     </div>
//   </div>
// );
...
//   <div className="col">
//     <div className="card h-100 bg-darker-custom rounded-xl p-4 text-center card-custom cursor-pointer" onClick={onClick}>
//       <div className="display-4 mb-3">{icon}</div>
//       <h4 className="text-white">{title}</h4>
//       <button className="btn btn-gold btn-sm mt-3 rounded-pill">Explore</button>
//     </div>
//   </div>
// );

// const FrontendGallery = ({ projects, onBack }) => (
//   <section className="py-5 bg-black min-vh-100">
//     <div className="container py-5">
//       <button onClick={onBack} className="btn btn-outline-light mb-5">← Back to Home</button>
//       <h2 className="display-4 text-gold mb-5 border-bottom border-gold pb-3">Frontend Development</h2>
//       <div className="row g-4">
//         {projects.map(p => (
//           <div className="col-md-6" key={p.id}>
//             <div className="card h-100 bg-darker-custom border-dark-subtle rounded-xl overflow-hidden card-custom">
//               <img src={p.src} className="card-img-top" alt={p.name} style={{height: '240px', objectFit: 'cover'}} />
//               <div className="card-body p-4">
//                 <h3 className="text-white">{p.name}</h3>
//                 <div className="my-2">
//                   {p.tech.map(t => <span key={t} className="badge bg-gold text-dark me-1">{t}</span>)}
//                 </div>
//                 <p className="text-secondary">{p.description}</p>
//                 <div className="d-flex gap-2">
//                   <a href={p.liveLink} className="btn btn-gold btn-sm">Live Demo</a>
//                   <a href={p.repoLink} className="btn btn-outline-light btn-sm">Source Code</a>
//                 </div>
//               </div>
//             </div>
//           </div>
...
// const UIUXGallery = ({ projects, onBack }) => (
//   <section className="py-5 bg-black min-vh-100">
//     <div className="container py-5">
//       <button onClick={onBack} className="btn btn-outline-light mb-5">← Back to Home</button>
//       <h2 className="display-4 text-gold mb-5 border-bottom border-gold pb-3">UI/UX Design</h2>
//       <div className="row g-4">
//         {projects.map(p => (
//           <div className="col-md-6" key={p.id}>
//             <div className="card h-100 bg-darker-custom border-dark-subtle rounded-xl overflow-hidden card-custom">
//               <img src={p.src} className="card-img-top" alt={p.name} style={{height: '300px', objectFit: 'cover'}} />
//               <div className="card-body p-4 text-center">
//                 <h3 className="text-white">{p.name}</h3>
//                 <p className="text-secondary">{p.description}</p>
//                 <a href={p.figmaLink} className="btn btn-gold w-100 rounded-pill">View Case Study / Prototype</a>
//               </div>
//             </div>
//           </div>
//         ))}
...
// const StandardGallery = ({ title, projects, onBack }) => (
//   <section className="py-5 bg-black min-vh-100">
//     <div className="container py-5">
//       <button onClick={onBack} className="btn btn-outline-light mb-5">← Back to Home</button>
//       <h2 className="display-4 text-gold mb-5 border-bottom border-gold pb-3">{title}</h2>
//       <div className="row row-cols-1 row-cols-md-3 g-4">
//         {projects.map(p => (
//           <div className="col" key={p.id}>
//             <div className="card h-100 bg-darker-custom border-dark-subtle rounded-xl overflow-hidden">
//               <img src={p.src} className="card-img-top" style={{height: '240px', objectFit: 'cover'}} alt={p.name} />
...
//     <div className="container py-5">
//       <button onClick={onBack} className="btn btn-outline-light mb-5">← Back to Home</button>
//       <h2 className="display-4 text-gold mb-5 border-bottom border-gold pb-3">Motion Graphics</h2>
//       <div className="row row-cols-1 row-cols-md-3 g-4">
//         {projects.map(p => (
//           <div className="col" key={p.id}>
//             <div className="card h-100 bg-darker-custom border-dark-subtle rounded-xl overflow-hidden cursor-pointer" onClick={() => onPlayVideo(p)}>
//               <div className="position-relative">
//                 <img src={p.thumbnail} className="card-img-top" style={{height: '240px', objectFit: 'cover'}} alt={p.title} />
//                 <div className="position-absolute top-50 start-50 translate-middle bg-dark bg-opacity-75 rounded-circle p-3">▶</div>
//               </div>
//               <div className="card-body">
